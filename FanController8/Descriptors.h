...
#define _DESCRIPTORS_H_
  ...
  /* Macros: */
	...
	#define CDC1_TX_EPADDR                 (ENDPOINT_DIR_OUT | 2)
	
		/** Endpoint address of the first CDC interface's device-to-host data IN endpoint. */
		#define CDC_IN_EPADDR                 (ENDPOINT_DIR_IN | 1)
		#define CDC_DEVICE_TO_HOST_EPADDR	  (ENDPOINT_DIR_IN | 1)

		/** Endpoint address of the first CDC interface's host-to-device data OUT endpoint. */
		#define CDC_OUT_EPADDR                 (ENDPOINT_DIR_OUT | 2)
		#define CDC_HOST_TO_DEVICE_EPADDR	   (ENDPOINT_DIR_OUT | 2)
	...
	#define CDC_CONTROL_EPADDR       (ENDPOINT_DIR_IN  | 3)
